...
public class ShakeActivity extends Activity{
	...
	public void startAnim () {   //定义摇一摇动画动�?
	...
	public void startVibrato(){		//定义震动
		mVibrator.vibrate( new long[]{500,200,500,200}, -1); //第一个｛｝里面是节奏数组�?第二个参数是重复次数�?1为不重复，非-1俄日从pattern的指定下标开始重�?
	}
	
	public void shake_activity_back(View v) {     //标题�?返回按钮
      	this.finish();
      }  
	public void linshi(View v) {     //标题�?
		startAnim();
      }  
	@Override
